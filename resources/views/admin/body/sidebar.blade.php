{{-- <div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class="fadeIn animated bx bx-building"></i>
                </div>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Supported Ticket</div>
            </a>
            <ul>
                <li>
        ...
        <li>
            <a href="javascript:;" >
                ...
                <div class="menu-title">Contact Massage</div>
            </a>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="#"><i class="bx bx-right-arrow-alt"></i>Pending Withdraw</a>
                </li>
                <li>
                    <a href="#"><i class="bx bx-right-arrow-alt"></i>Completed Withdraw</a>
                </li>
                <li>
                    <a href="#"><i class="bx bx-right-arrow-alt"></i>Rejected Withdraw</a>
                </li>
                <li>
                    <a href="#"><i class="bx bx-right-arrow-alt"></i>All Withdraw</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="#"><i class="bx bx-right-arrow-alt"></i>Deposit</a>
                </li>
                <li>
                    <a href="#"><i class="bx bx-right-arrow-alt"></i>All Withdraw</a>
                </li>
...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{ asset('backend/assets/images/logo.png') }}" class="logo-icon" alt="logo icon" style="width: 50px; height: 50px;">
        </div>
        <div>
            <h4 class="logo-text">Mentorship</h4>
        </div>
        <div class="toggle-icon ms-auto"><i class='bx bx-arrow-to-left'></i>
        </div>
    </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="{{ route('subscribermanager') }}" >
                <div class="parent-icon"><i class="fadeIn animated bx bx-like"></i>
                </div>
                <div class="menu-title">Subscriber</div>
            </a>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{ route('pendingwithdraw')}}"><i class="bx bx-right-arrow-alt"></i>Pending Withdraw</a>
                </li>
                <li>
                    <a href="{{ route('completedwithdraw') }}"><i class="bx bx-right-arrow-alt"></i>Completed Withdraw</a>
                </li>
                <li>
                    <a href="{{ route('rejectedwithdraw') }}"><i class="bx bx-right-arrow-alt"></i>Rejected Withdraw</a>
                </li>
                <li>
                    <a href="{{ route('allwithdraw') }}"><i class="bx bx-right-arrow-alt"></i>All Withdraw</a>
                </li>
